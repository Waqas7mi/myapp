    ...
    <footer class="bg-background-tertiary text-white bg-indigo-600">
        <div class="container mx-auto flex flex-col sm:flex-row items-center justify-between py-8">
            ...
            <ul class="flex items-center space-x-8">
                <li><a href="mailto:khan7mi@gmail.com" class="text-white hover:text-gray-400">
                ...
                <li><a href="#" target="_blank" class="text-white hover:text-gray-400">


                        <svg width="25" height="25" class="bg-gray-200" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
    ...
    <g>
        <path d="M468.333-1H41.667C17.773-1-1,17.773-1,41.667v426.667C-1,492.227,17.773,511,41.667,511h196.267h102.4h128
			...
			c-14.507,0-25.6-11.093-25.6-25.6V41.667c0-14.507,11.093-25.6,25.6-25.6h426.667c14.507,0,25.6,11.093,25.6,25.6V468.333z"/>
                ...
                <li><a href="https://github.com/waqas7mi" target="_blank" class="text-white hover:text-gray-400">
